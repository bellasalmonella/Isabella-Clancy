...
let processingLink = document.querySelector('#processing-link');

let linkArray = [collectionsLink, newLink, trendingLink, popularLink, processingLink];

linkArray.forEach((eachLink) => {
	eachLink.addEventListener('click', (e) => {
	  switch (eachLink) {
		case collectionsLink:
		  fetchPage(eachLink, '/beller-portfolio - Copy/collections.html');
		  break;
  
		case newLink:
		  fetchPage(eachLink, '/beller-portfolio - Copy/newPage.html');
		  break;
  
		case trendingLink:
		  fetchPage(eachLink, '/beller-portfolio - Copy/trending.html');
		  break;
  
		case popularLink:
		  fetchPage(eachLink, '/beller-portfolio - Copy/popular.html');
		  break;
  
		case processingLink:
		  fetchPage(eachLink, '/beller-portfolio - Copy/processing.html');
		  break;
	  }
	});
  });
